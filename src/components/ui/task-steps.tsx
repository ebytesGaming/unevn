          ...
          return (
            ...
            >
              <span className="relative grid size-4 shrink-0 place-items-center">
                <AnimatePresence initial={false}>
                  {row.status === "done" ? (
                    <motion.span
                      key="done"
                      className="col-start-1 row-start-1 grid size-4 place-items-center rounded-[5px] bg-pine/[0.16] text-pine"
                      initial={
                    ...
                    <motion.span
                      key="error"
                      className="col-start-1 row-start-1 grid size-4 place-items-center rounded-[5px] bg-rust/[0.14] text-rust"
                      initial={
                        reduced ? { opacity: 0 } : { opacity: 0, scale: 0.4 }
                      }
                      animate={{ opacity: 1, scale: 1 }}
                    ...
                    <motion.span
                      key="active"
                      className="col-start-1 row-start-1 text-brass"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0, transition: STILL }}
                    ...
                    <motion.span
                      key="pending"
                      className="col-start-1 row-start-1 size-[5px] rounded-[2px] bg-muted-2/50"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0, transition: STILL }}
                      transition={STILL}
              ...
              {row.status === "active" && !reduced ? (
                <motion.span
                  className="min-w-0 flex-1 truncate bg-[linear-gradient(90deg,#66655F_38%,#FAFAF8_50%,#66655F_62%)] bg-clip-text text-[12.5px] font-medium text-transparent [background-size:220%_100%]"
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12.5px] transition-colors duration-200 font-mono ${tone}`}
                >
                  {row.label}
                </span>
              )}
