...
export default function MultistepForm() {
  ...
  const valid = () => {
    ...
    if (currentStep === 6) return formData.consultationDate !== "";
    return true;
  };
